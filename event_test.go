...
func (a TestEventRegister) AggregateID() ID              { return UUID("") }
...
func (a TestEventRegisterEmpty) AggregateID() ID              { return UUID("") }
...
func (a TestEventRegisterTwice) AggregateID() ID              { return UUID("") }
